...
locador = Locador('Manoel',  '30-10-1999', '03951567260', 'Brasileiro',
                  '68925153', '781', '96991934171', 'manoelgomes53@gmail.com')
locatario = Locatario('Gustavo',  '30-10-1996', '03951567260', 'Brasileiro',
                      '68903770', '781', '96991934171', 'manoelgomes53@gmail.com', "42443232324")

Imovel1 = Galpao(locador, float(2.999), "Area de lazer",
                 '68925153', '781', float(59.76), float(80.89))
# Imovel1.getInformation()

Imovel2 = Residencia(locador, "Casa Geminada", float(
    2999), "Area de lazer", '68925153', '781', float(59.76), float(80.89), 1, 2, 3, 4)
...
print('IMPRIMINDO DADOS DO IMOVEL DE UM CONTRATO\n\n')
